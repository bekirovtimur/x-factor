...
# Функция для извлечения IP/домена из URL
...
generate_server_name() {
    ...
    # Получаем флаг страны динамически
    local country_flag=$(curl -s https://getflag.vercel.app/${country_code})
